...
def four_point_transform(image, pts):
    ...
    # compute the width of the new image, which will be the maximum distance between bottom-right and bottom-left x-coordinates or top-right and top-left x-coordinates